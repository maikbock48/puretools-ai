...
export default function Navbar({ lng }: NavbarProps) {
  ...
  return (
    <motion.nav
      ...
      className="fixed top-0 left-0 right-0 z-50 border-b border-zinc-800 bg-zinc-950/80 backdrop-blur-xl"
    >
        ...
        <div className="flex h-16 items-center justify-between">
          ...
          <Link href={`/${lng}`} className="flex items-center gap-2 group">
            <div className="relative">
              ...
              <Sparkles className="relative h-8 w-8 text-indigo-400" />
            </div>
            <span className="text-xl font-semibold text-white">
              Pure<span className="text-indigo-400">Tools</span>
            </span>
          </Link>
