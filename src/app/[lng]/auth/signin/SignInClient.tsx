...
import { Loader2, Sparkles, Shield, CreditCard } from 'lucide-react';
...
const content = {
  en: {
    ...
    subtitle: 'Sign in to access AI-powered tools',
    benefits: [
  ...
  de: {
    ...
    subtitle: 'Melde dich an, um auf KI-Tools zuzugreifen',
    benefits: [
    ...
    >
      <div className="rounded-2xl border border-zinc-800 bg-zinc-900/50 p-8 shadow-xl">
        ...
        <div className="text-center mb-8">
          <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-indigo-500 to-emerald-500">
        ...
        <div className="space-y-3">
          <button
            ...
            className="flex w-full items-center justify-center gap-3 rounded-xl border border-zinc-700 bg-zinc-800 px-4 py-3 font-medium text-white transition-all hover:bg-zinc-700 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {isLoadingGoogle ? (
        ...
        <p className="mt-6 text-center text-xs text-zinc-500">
          {t.terms}{' '}
          <a href={`/${lng}/terms`} className="text-indigo-400 hover:underline">
            {t.termsLink}
          </a>{' '}
          {t.and}{' '}
          <a href={`/${lng}/privacy`} className="text-indigo-400 hover:underline">
            {t.privacyLink}
          </a>
          .
        </p>
